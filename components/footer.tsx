    ...
    <footer className="border-t border-border bg-muted/30">
      <div className="container mx-auto px-4 py-12 lg:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Kenya's most trusted escrow platform for secure online and offline
              transactions.
            </p>
          ...
          <div>
            <h3 className="mb-4 font-poppins text-sm font-semibold text-foreground">
              Quick Links
            </h3>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                ...
                <div>
                  <p>
                    <a
                      href="tel:+254736368320"
                      className="transition-colors hover:text-primary"
                    >
                      +254 736368320
                    </a>
                  </p>
                  <p className="text-xs mt-1">24/7/365 - Always Available</p>
                </div>
              </li>
              <li className="flex items-start gap-2 text-sm text-muted-foreground">
                <MapPin className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
                <div>
                  <p>Nairobi Innovation Hub</p>
                  <p>Nairobi, Kenya</p>
                </div>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-border pt-8 text-center text-sm text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Safeswap. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
